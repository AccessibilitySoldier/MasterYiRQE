...
if not table.contains(Heroes, charName) then 
	print("Master Yi RQE - " ..charName.. " is not supported, loading other modules...")
else
	print("Master Yi RQE loading...")
end
...
function()	
	...
	Menu = MenuElement({type = MENU, id = charName, name = "Master Yi RQE "..charName})	
...
function MasterYi:LoadMenu()
	...
	--- Combo ---
		...
		Menu.Combo:MenuElement({id = "useE", name = "Use E after Q", value = true})
		Menu.Combo:MenuElement({id = "useR", name = "Use R close to the enemy", value = true})
...
function MasterYi:OnTick()
	...
	self.eTarget 	= Utils:GetTarget(Q.range) -- equals Q
...
function MasterYi:CastRcombo(unit)
